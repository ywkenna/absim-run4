...
//    float getVehicleWaitingTimeBaseVehForLink() {  return myVehWaitingTimeBaseVehForLink;  };
    ...
    void setMyEventUniDirCapacity(double capacity);
...
//    VehicleManager myVehManager = VehicleManager::getInstance();
	...
	bool myPocketFlag = false;    // left of right pocket cell, the capacity is double

    bool myEventUniDirOppCapFlag = false;    // Under Uni-Direction-Restrict Event, opposite link's capacity is multiplied
    double myEventUniDirCapacity = 1.0;
