...
public:
    ...
    ModelInterface(NetworkManager* _nm, VehicleManager* _vm, TrafficSignalManager* _tsm, OutputWriter* _ow, EventManager* _ev) : myNetworkManager(_nm), myVehicleManager(_vm), myTrafficSignalManager(_tsm), myOutputWriter(_ow), myEventManager(_ev){};
