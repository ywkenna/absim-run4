...
public:
	...
	Result configureSimulation(string scenarioFile, string partitionID="", int option=0);
...
public:
    ...
    // For write the trajectory log
//    Result writeTrajectory();
    // Check the Event option
    bool isWithEvent(){  return myEvent;  }
...
private:
    ...
    // whether the simulation contains the event or not
    bool myEvent=false;

    bool myTrajectoryLog=false;
