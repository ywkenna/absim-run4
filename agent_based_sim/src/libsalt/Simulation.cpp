...
namespace libsalt {
    ...
    SALT::Router * Simulation::RT = nullptr;
...
//            VC->stop();
    ...
    SALT::SimulationController *Simulation::getSimulationController() {
        return SC;
    }

    bool Simulation::setConfigForRouting() {
        RT = new SALT::Router();
        return RT->getConfig(scenarioFile);
    }

    SALT::Router *Simulation::getRouter() {
        return RT;
    }
